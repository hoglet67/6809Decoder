...
gcc -Wall -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -O3 $DEFS $INCS -o decode6809 src/main.c src/memory.c src/em_6809.c src/musl_tsearch.c $LIBS
