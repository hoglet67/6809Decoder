...
static opcode_t instr_table_6309[] = {
   ...
   /* 1100 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1101 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1102 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1103 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1104 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1105 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1106 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1107 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1108 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1109 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 110A */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 110B */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 110C */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 110D */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 110E */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 110F */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1110 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1111 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1112 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1113 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1114 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1115 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1116 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1117 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1118 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1119 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 111A */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 111B */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 111C */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 111D */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 111E */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 111F */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1120 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1121 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1122 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1123 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1124 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1125 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1126 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1127 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1128 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1129 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 112A */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 112B */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 112C */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 112D */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 112E */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 112F */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   ...
   /* 1163 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1164 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1165 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1166 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1167 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1168 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1169 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 116A */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 116B */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 116C */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 116D */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 116E */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 116F */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1170 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1171 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1172 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1173 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1174 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1175 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1176 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1177 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1178 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1179 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 117A */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 117B */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 117C */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 117D */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 117E */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 117F */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1180 */  { &op_SUBE , IMMEDIATE_8  , 0, 3, 3 },
   /* 1181 */  { &op_CMPE , IMMEDIATE_8  , 0, 3, 3 },
   /* 1182 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1183 */  { &op_CMPU , IMMEDIATE_16 , 0, 5, 4 },
   /* 1184 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1185 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1186 */  { &op_LDE  , IMMEDIATE_8  , 0, 3, 3 },
   /* 1187 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1188 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1189 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 118A */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   ...
   /* 1192 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1193 */  { &op_CMPU , DIRECT       , 0, 7, 5 },
   /* 1194 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1195 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1196 */  { &op_LDE  , DIRECT       , 0, 5, 4 },
   /* 1197 */  { &op_STE  , DIRECT       , 0, 5, 4 },
   /* 1198 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 1199 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 119A */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   ...
   /* 11A2 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11A3 */  { &op_CMPU , INDEXED      , 0, 7, 6 },
   /* 11A4 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11A5 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11A6 */  { &op_LDE  , INDEXED      , 0, 5, 5 },
   /* 11A7 */  { &op_STE  , INDEXED      , 0, 5, 5 },
   /* 11A8 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11A9 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11AA */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   ...
   /* 11B2 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11B3 */  { &op_CMPU , EXTENDED     , 0, 8, 6 },
   /* 11B4 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11B5 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11B6 */  { &op_LDE  , EXTENDED     , 0, 6, 5 },
   /* 11B7 */  { &op_STE  , EXTENDED     , 0, 6, 5 },
   /* 11B8 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11B9 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11BA */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   ...
   /* 11C2 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11C3 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11C4 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11C5 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11C6 */  { &op_LDF  , IMMEDIATE_8  , 0, 3, 3 },
   /* 11C7 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11C8 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11C9 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11CA */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11CB */  { &op_ADDF , IMMEDIATE_8  , 0, 3, 3 },
   /* 11CC */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11CD */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11CE */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11CF */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11D0 */  { &op_SUBF , DIRECT       , 0, 5, 4 },
   /* 11D1 */  { &op_CMPF , DIRECT       , 0, 5, 4 },
   /* 11D2 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11D3 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11D4 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11D5 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11D6 */  { &op_LDF  , DIRECT       , 0, 5, 4 },
   /* 11D7 */  { &op_STF  , DIRECT       , 0, 5, 4 },
   /* 11D8 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11D9 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11DA */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11DB */  { &op_ADDF , DIRECT       , 0, 5, 4 },
   /* 11DC */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11DD */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11DE */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11DF */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11E0 */  { &op_SUBF , INDEXED      , 0, 5, 5 },
   /* 11E1 */  { &op_CMPF , INDEXED      , 0, 5, 5 },
   /* 11E2 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11E3 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11E4 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11E5 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11E6 */  { &op_LDF  , INDEXED      , 0, 5, 5 },
   /* 11E7 */  { &op_STF  , INDEXED      , 0, 5, 5 },
   /* 11E8 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11E9 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11EA */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11EB */  { &op_ADDF , INDEXED      , 0, 5, 5 },
   /* 11EC */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11ED */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11EE */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11EF */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11F0 */  { &op_SUBF , EXTENDED     , 0, 6, 5 },
   /* 11F1 */  { &op_CMPF , EXTENDED     , 0, 6, 5 },
   /* 11F2 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11F3 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11F4 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11F5 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11F6 */  { &op_LDF  , EXTENDED     , 0, 6, 5 },
   /* 11F7 */  { &op_STF  , EXTENDED     , 0, 6, 5 },
   /* 11F8 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11F9 */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11FA */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11FB */  { &op_ADDF , EXTENDED     , 0, 6, 5 },
   /* 11FC */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11FD */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11FE */  { &op_TRAP , ILLEGAL      , 0,21,23 },
   /* 11FF */  { &op_TRAP , ILLEGAL      , 0,21,23 }
};
